...
Hãy nhanh chân đến cửa hàng Mykingdom gần nhất để sở hữu ngay mô hình ngộ nghĩnh và đáng yêu này cho bé nhà mình bạn nhé!', 11, 11);
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (73, 449400, NULL, 41, 'Đồ Chơi Mô Hình Quái Thạch Hung Hãn SCHLEICH 70141S', JSON_OBJECT('Chủ đề', 'SCHLEICH ELDRADOR CREATURES', 'Mã sản phẩm', '70141S', 'Tuổi', '3 tuổi trở lên', 'Thương hiệu', 'SCHLEICH', 'Xuất xứ thương hiệu', 'Đức', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Trung Quốc'), 'Khi quái thạch di chuyển, cả vũ trụ Eldrador đều rung chuyển. Nó có thể không nhanh nhẹn, thông minh nhưng lại có một sức mạnh vô đối. Nó có thể xoay thân trên của mình vô cùng linh hoạt và tiêu diệt kẻ thù bằng nắm đấm cực khỏe của mình. Quái thạch sẽ trở nên hung mạnh hơn khi ăn những viên pha lê xanh', 11, 11);

INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (74, 239400, NULL, 28, 'Đồ Chơi Mô Hình Sói Băng Tinh Tường SCHLEICH 42452', JSON_OBJECT('Chủ đề', 'SCHLEICH ELDRADOR CREATURES', 'Mã sản phẩm', '42452', 'Tuổi', '3 tuổi trở lên', 'Thương hiệu', 'SCHLEICH', 'Xuất xứ thương hiệu', 'Đức', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Trung Quốc'), 'Với bộ lông trắng muốt của mình, Sói băng có thể trở nên vô hình trong tuyết và bất thình lình nhào ra phục kích và tấn công đối thủ. Không có gì có thể vượt qua được đôi mắt và khướu giác tinh tường của nó. Sói băng có thể triệu hồi trợ thủ đắc lực của mình là Băng long bằng tiếng tru vang vọng', 11, 11);
...
Thông tin thú vị: Tyrannosaurus Rex có 50 chiếc răng sắc như lưỡi cưa, nhọn và dài tới 25 cm.', 11, 11);
...
Là một trong những nhà sản xuất mô hình động vật hàng đầu thế giới được cố vấn bởi các chuyên gia cổ sinh vật học, CollectA nổi bật với chất lượng vượt trội trong từng chi tiết tạo hình và màu sắc. Sản phẩm được ứng dụng rộng rãi trong giáo dục, góp phần nâng cao nhận thức bảo vệ động vật quý hiếm và lan tỏa tình yêu với thiên nhiên hoang dã.
Điểm nổi bật:- Lớp sơn được thực hiện thủ công cho chi tiết sắc nét, sống động và độc bản.- Làm từ nhựa PVC an toàn cho bé, không chứa Phthalate.- Tạo hình chân thực và đa dạng loài, phù hợp cho mục đích giáo dục
Thông tin thú vị: Cá voi sát thủ nổi bật nhờ trí thông minh vượt trội, khả năng săn mồi theo đàn và chiến thuật đa dạng để hạ gục con mồi lớn, ngoại hình đen trắng tương phản đặc trưng cùng kích thước ấn tượng, và sự phân bố rộng rãi khắp các đại dương.', 11, 11);
...
Là một trong những nhà sản xuất mô hình động vật hàng đầu thế giới được cố vấn bởi các chuyên gia cổ sinh vật học, CollectA nổi bật với chất lượng vượt trội trong từng chi tiết tạo hình và màu sắc. Sản phẩm được ứng dụng rộng rãi trong giáo dục, góp phần nâng cao nhận thức bảo vệ động vật quý hiếm và lan tỏa tình yêu với thiên nhiên hoang dã.
Điểm nổi bật:- Lớp sơn được thực hiện thủ công cho chi tiết sắc nét, sống động và độc bản.- Làm từ nhựa PVC an toàn cho bé, không chứa Phthalate.- Tạo hình chân thực và đa dạng loài, phù hợp cho mục đích giáo dục
Thông tin thú vị: Hươu cao cổ Reticulated là động vật nhai lại, giống như bò và các loài móng guốc khác. Dạ dày của chúng có bốn ngăn.Thức ăn sẽ đi qua ngăn đầu tiên, còn nước thì được chuyển trực tiếp đến ngăn thứ hai.', 11, 11);
