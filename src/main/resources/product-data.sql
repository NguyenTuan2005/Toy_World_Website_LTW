...
Xây dựng động cơ V12 với piston chuyển động và thử bộ vi sai thật
Tận hưởng màu đỏ đặc trưng huyền thoại của Ferrari
...
Trang trí đẹp mắt cho kệ sách, bàn học hay góc LEGO yêu thích của bé
...
Các chi tiết thực tế: hệ thống lái, hệ thống treo, cánh gió điều chỉnh và 3 bình NOS
Chức năng drift độc đáo nâng xe lên để tạo các pha drift đẹp mắt
Động cơ 6 xi-lanh với pistons chuyển động sống động
Quà tặng sáng tạo dành cho người lớn yêu thích dự án mô hình và xe hơi
Hướng dẫn xây dựng kỹ thuật số có trong ứng dụng LEGO® Builder
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (7, 1095200, NULL, 52, 'Đồ Chơi Lắp Ráp Rồng Bậc Thầy Rontu LEGO NINJAGO 71842', JSON_OBJECT('Chủ đề', 'LEGO NINJAGO PLAY THEMES', 'Mã sản phẩm', '71842', 'Tuổi', '7 tuổi trở lên', 'Thương hiệu', 'LEGO NINJAGO', 'Xuất xứ thương hiệu', 'Đan Mạch', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi Lắp Ráp Rồng Bậc Thầy Rontu LEGO NINJAGO 71842 (381 chi tiết)
Gia nhập đội ninja gồm Sora, Wyldfyre, Lloyd và Rồng sư phụ Rontu trong hành trình vượt qua Zarkt – Chúa tể Xui Xẻo, kẻ đang canh giữ ngôi đền cổ. Hãy tấn công từ bầu trời với súng bắn đạn của Rontu, hoặc chiến đấu trên mặt đất bằng vũ khí đặc biệt của các ninja. Liệu các anh hùng có thể chiến thắng? Tất cả phụ thuộc vào bạn!
Tính năng nổi bật:
Bộ đồ chơi rồng cho trẻ tái hiện các pha hành động từ mùa 3 của NINJAGO® Dragons Rising
Rồng Rontu có thể cử động đuôi, chân, cánh, đầu và hàm – mang đến trải nghiệm sống động
Mô hình ngôi đền mini được lắp ghép từ gạch, ẩn chứa một bí mật bất ngờ
Gồm 4 minifigure: Wyldfyre, Sora, Lloyd và Zarkt – kẻ phản diện chính
Món quà sinh nhật tuyệt vời cho trẻ từ 7 tuổi trở lên, yêu thích nhập vai và phiêu lưu
Tận hưởng trải nghiệm lắp ráp trực quan với hướng dẫn 3D trên ứng dụng LEGO® Builder
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (8, 4249000, NULL, 89, 'Đồ Chơi Lắp Ráp Lâu Đài Trung Cổ Của Kỵ Sĩ LEGO CREATOR 31168', JSON_OBJECT('Chủ đề', 'LEGO CREATOR BUILDINGS', 'Mã sản phẩm', '31168', 'Tuổi', '9 tuổi trở lên', 'Thương hiệu', 'LEGO CREATOR', 'Xuất xứ thương hiệu', 'Đan Mạch', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi Lắp Ráp Lâu Đài Trung Cổ Của Kỵ Sĩ LEGO CREATOR 31168 (1371 Chi Tiết)
Quay ngược thời gian để bước vào hành trình kịch tính tại Lâu Đài Hiệp Sĩ Cưỡi Ngựa thời Trung Cổ! Băng qua cầu kéo, khám phá phòng ngủ của đức vua, đại sảnh tráng lệ và chuồng ngựa đầy chi tiết Rồi nhảy lên lưng ngựa để bảo vệ lâu đài khỏi các thế lực thù địch đang xâm lược! Muốn thêm phần hấp dẫn? Biến tấu thành sân chơi hiệp sĩ hoặc làng trung cổ yên bình với cối xay gió!
Với bộ 3in1 này, mọi khả năng sáng tạo đều nằm trong tay bạn Trẻ có thể tha hồ sáng tạo và tái tạo 3 mô hình khác nhau đậm chất trung cổ tự do hóa thân vào các câu chuyện phiêu lưu với lâu đài, trò chơi hiệp sĩ hoặc ngôi làng thời xưa Mô hình lâu đài chứa đầy chi tiết thú vị và có thể mở phía sau để chơi bên trong
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (9, 2289000, NULL, 12, 'Đồ Chơi Lắp Ráp WALL-E Và EVE LEGO DISNEY PRINCESS 43279', JSON_OBJECT('Chủ đề', 'LEGO DISNEY CLASSIC ADULT', 'Mã sản phẩm', '43279', 'Tuổi', '18 tuổi trở lên', 'Thương hiệu', 'LEGO DISNEY PRINCESS', 'Xuất xứ thương hiệu', 'Đan Mạch', 'Giới tính', 'Unisex', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi Lắp Ráp WALL-E Và EVE LEGO DISNEY PRINCESS 43279 (811 chi tiết)
Thỏa mãn niềm đam mê lắp ráp khi bạn tạo hình WALL-E và EVE cùng các bạn đồng hành từ Disney và Pixar.Trong lúc lắp ráp, bạn có thể khám phá những gì WALL-E cất giấu trong kho lưu trữ.Giúp EVE bảo quản chồi cây an toàn để phân tích.Để M-O dọn dẹp – nhưng hãy cẩn thận kẻo cậu ấy hút nhầm Hal.Và với ứng dụng LEGO® Builder, bạn có thể cùng lắp ráp với bạn bè và gia đình.
Tặng người hâm mộ WALL-E của Disney và Pixar một bộ lắp ghép dành cho người lớn đầy niềm vui
4 nhân vật chi tiết từ Disney và Pixar gồm WALL-E, EVE, M-O và Hal
Trải nghiệm lắp ráp truyền cảm hứng với kỹ thuật nâng cao để khơi dậy sự sáng tạo
Bộ mô hình lấy cảm hứng từ phim, thích hợp để trưng bày tại nhà hoặc nơi làm việc
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (10, 6499000, NULL, 96, 'Đồ Chơi Lắp Ráp Siêu Xe Thể Thao Lamborghini Revuelto LEGO TECHNIC 42214', JSON_OBJECT('Chủ đề', 'LEGO TECHNIC ALL', 'Mã sản phẩm', '42214', 'Tuổi', '10 tuổi trở lên', 'Thương hiệu', 'LEGO TECHNIC', 'Xuất xứ thương hiệu', 'Đan Mạch', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi Lắp Ráp Siêu Xe Thể Thao Lamborghini Revuelto LEGO TECHNIC 42214 (1135 Chi Tiết)
Đây chính là giấc mơ trở thành hiện thực! Lamborghini Revuelto kết hợp sức mạnh và độ chính xác để tạo nên siêu xe có một không hai.
Giờ đây bạn có thể tự tay lắp ráp mô hình siêu xe Lamborghini Revuelto với bộ LEGO® Technic™ này. Khám phá hệ thống đèn cực “ngầu” với các chi tiết phát sáng trong bóng tối!
Cảm nhận tốc độ khi điều khiển siêu xe Revuelto bằng ứng dụng LEGO Technic CONTROL+ hiện đại!
Dành cho các bé từ 10 tuổi trở lên đam mê xe mô hình siêu cấp Siêu xe điều khiển từ xa sử dụng ứng dụng LEGO® Technic™ CONTROL+
Có thể điều khiển tiến lùi linh hoạt và chiêm ngưỡng hiệu ứng phát sáng cực chất
Bao gồm pin sạc cho mô hình xe (không kèm cáp sạc)
...
Mô hình LEGO® Speed Champions Bugatti Centodieci – siêu xe hypercar tối thượng
Bao gồm nhân vật minifigure tài xế Bugatti, sẵn sàng vào buồng lái cho các màn nhập vai gay cấn
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (12, 9539000, NULL, 19, 'Đồ Chơi Lắp Ráp Tàu Vũ Trụ Lớp Firespray Của Jango Fett LEGO STAR WARS 75409', JSON_OBJECT('Chủ đề', 'LEGO STAR WARS TM', 'Mã sản phẩm', '75409', 'Tuổi', '18 tuổi trở lên', 'Thương hiệu', 'LEGO STAR WARS', 'Xuất xứ thương hiệu', 'Đan Mạch', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi Lắp Ráp Tàu Vũ Trụ Lớp Firespray Của Jango Fett LEGO STAR WARS 75409 (2970 Chi Tiết)
Tái hiện những khoảnh khắc kinh điển từ Star Wars: Attack of the Clones™ khi bạn lắp ráp phiên bản Ultimate Collector Series hoành tráng của tàu Firespray-Class – thuộc sở hữu của Jango Fett!
Tàu được thiết kế cực kỳ chi tiết với buồng lái có thể tháo rời dành cho Jango Fett và Boba Fett nhí, cùng một khoang chứa bom xung kích seismic.
Có thể trưng bày ở chế độ hạ cánh hoặc đặt trên giá đỡ dựng đứng để chiêm ngưỡng từ mọi góc độ.
LEGO® Star Wars™ UCS – Mô hình trưng bày tàu chiến đỉnh cao dành cho nhà sưu tầm
Gồm 2 minifigure độc quyền: Jango Fett và Boba Fett thời thơ ấu
Thiết kế chi tiết với: buồng lái mở được, khoang chứa bom xung kích, cùng nhiều điểm nhấn kỹ thuật
Có thể trưng bày trên mặt phẳng hoặc dựng đứng trên giá đỡ chuyên dụng để tạo hiệu ứng đang bay
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (13, 4869000, NULL, 96, 'Đồ Chơi Lắp Ráp Cỗ Máy Hủy Diệt Juggernaut LEGO STAR WARS 75413', JSON_OBJECT('Chủ đề', 'LEGO STAR WARS TM', 'Mã sản phẩm', '75413', 'Tuổi', '9 tuổi trở lên', 'Thương hiệu', 'LEGO STAR WARS', 'Xuất xứ thương hiệu', 'Đan Mạch', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi Lắp Ráp Cỗ Máy Hủy Diệt Juggernaut LEGO STAR WARS 75413 (813 Chi Tiết)
Lăn bánh ra chiến trường cùng chiếc Republic Juggernaut hùng mạnh, từng xuất hiện trong Star Wars: The Clone Wars™!Hãy cùng Ki-Adi-Mundi và Chỉ huy Bacara điều khiển cỗ xe 10 bánh siêu ngầu này. Đặt các binh sĩ Thủy Quân Lục Chiến Thiên Hà vào buồng lái trước và sau. Nghiêng thân xe để điều khiển hướng đi. Từ tháp quan sát, hãy truy tìm các Droid Chiến Đấu và kích hoạt súng bắn đạn ở tháp pháo phía sau để khai hỏa!
Đồ chơi mô hình LEGO® Star Wars™ – Xe vận chuyển dành cho trẻ emGồm 5 minifigure LEGO® Star Wars™ và 3 Droid Chiến Đấu, kèm phụ kiện đầy đủ
Tính năng lái xe bằng cách nghiêng thân xe, 2 buồng lái, tháp quan sát nâng lên, và súng bắn đạn
Mở phần hông và tháo phần trên để khám phá khoang trung tâm chi tiết bên trong
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (14, 9119000, NULL, 29, 'Đồ Chơi Lắp Ráp Lâu Đài Neuschwanstein LEGOARCHITECTURE 21063', JSON_OBJECT('Chủ đề', 'LEGO ARCHITECTURE ALL', 'Mã sản phẩm', '21063', 'Tuổi', '18 tuổi trở lên', 'Thương hiệu', 'LEGOARCHITECTURE', 'Xuất xứ thương hiệu', 'Đan Mạch', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi Lắp Ráp Lâu Đài Neuschwanstein LEGOARCHITECTURE 21063 (3455 Chi Tiết)
Đắm mình trong vẻ đẹp huyền thoại của lâu đài NeuschwansteinHãy lắp ráp khung cảnh rừng núi bao quanh tòa lâu đài và thay đổi màu lá cây để chuyển mùa từ hạ sang thu. Dựng lên những tòa tháp cao vút, sân trong với các bậc cầu thang liên kết, và khám phá những chi tiết nội thất tinh xảo ẩn bên trong khi bạn dần hoàn thiện toàn bộ lâu đài. Cuối cùng, chiêm ngưỡng công trình biểu tượng qua toàn bộ vẻ đẹp kỳ ảo của nó.
Bộ mô hình lâu đài Neuschwanstein dành cho người lớn yêu thích lịch sử và du lịchTái hiện chân thực lâu đài với các tòa tháp, sân trong, cảnh quan xung quanh và nhiều chi tiết khác
Lá cây có thể thay đổi, cho phép bạn chuyển cảnh từ mùa hè sang mùa thu tùy theo sở thích
Trong quá trình xây dựng, bạn sẽ khám phá nội thất thu nhỏ được thiết kế tinh tế bên trong lâu đài
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (15, 916300, NULL, 6, 'Xe tập đi 3 trong 1 PEEK A BOO EU461542', JSON_OBJECT('Chủ đề', 'PEEK TODDLERS TOY', 'Mã sản phẩm', 'EU461542', 'Tuổi', '6 tháng tuổi trở lên', 'Thương hiệu', 'PEEK A BOO', 'Xuất xứ thương hiệu', 'Việt Nam', 'Giới tính', 'Preschool', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi PEEK A BOO Xe Tập Đi 3 Trong 1 EU461542

Cho bé từ 6 tháng là một trong những sản phẩm được ưa chuộng nhất trong dòng đồ chơi giáo dục và vận động
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (16, 335200, NULL, 57, 'Bộ lục lạc 6 món cho bé PEEK A BOO 939A', JSON_OBJECT('Chủ đề', 'PEEK NEWBORN TOYS', 'Mã sản phẩm', '939A', 'Tuổi', '0 tuổi trở lên', 'Thương hiệu', 'PEEK A BOO', 'Xuất xứ thương hiệu', 'Việt Nam', 'Giới tính', 'Preschool', 'Nơi sản xuất', 'Trung Quốc'), '
BỘ LỤC LẠC 6 MÓN CHO BÉ PEEK A BOO  939A

Trẻ từ 3 tháng tuổi sẽ bắt đầu học cách sử dụng các ngón tay để cầm, nắm đồ vật đồng thời có những phản xạ với âm thanh, màu sắc và hình dáng khác nhau!Bộ lục lạc 6 món của Peek A-Boo chính là sự lựa chọn tuyệt vời nhất cho bé. Bộ lục lạc gồm:
1. Quả bóng thông minh:
2. Kèn Trumpet
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (17, 629250, NULL, 21, 'Bộ trống kèm piano vui nhộn PEEK A BOO PAB003', JSON_OBJECT('Chủ đề', 'PEEK TODDLERS TOY', 'Mã sản phẩm', 'PAB003', 'Tuổi', '3 tuổi trở lên', 'Thương hiệu', 'PEEK A BOO', 'Xuất xứ thương hiệu', 'Việt Nam', 'Giới tính', 'Preschool', 'Nơi sản xuất', 'Trung Quốc'), 'Bộ  Đồ Chơi Trống Kèm Piano Vui Nhộn   Peek A Boo PAB003
Bộ nhạc cụ 5 trong 1 - Peek A Boo
Một sản phẩm kết hợp nhiều nhạc cụ cho bé thoải mái trải nghiệm và sáng tạo hết mình:
- Piano
- Xylophone
-   Cymbal
-   Trống
-   Micro
Đặc biệt, đàn Pinao có thể chỉnh 4 chế độ âm thanh khác nhau:
-   Chế độ âm thanh Piano
-   Chế độ Solmization
-     Chế độ âm thanh kèn Trumpet
-     Chế độ âm thanh đàn Ghita
Với bộ trống, bé cũng có thể thoải mái sáng tạo với 3 chế độ:
-     Âm thanh nhạc Jazz
-     Âm thanh nhạc Djembe
-   Hoặc chọn phát các bài nhạc có sẵn
Với Xylophone, bé cũng có thể chọn 4 chế độ sau:
-     Chế độ tone Glockenspiel
-     Chế độ tiếng động vật: 7 âm thanh động vật thường gặp
-   Chế độ đếm số
-   Chế độ tone Xylophone
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (18, 249000, NULL, 38, 'Đồ chơi bảng vẽ nam châm cho bé - Cá voi cam đáng yêu PEEK A BOO PAB029', JSON_OBJECT('Chủ đề', 'PEEK TODDLERS TOY', 'Mã sản phẩm', 'PAB029', 'Tuổi', '3 tuổi trở lên', 'Thương hiệu', 'PEEK A BOO', 'Xuất xứ thương hiệu', 'VIỆT NAM', 'Giới tính', 'Unisex', 'Nơi sản xuất', 'TRUNG QUỐC'), 'Đồ Chơi PEEK A BOO Bảng Vẽ Nam Châm Cho Bé - Cá Voi Cam Đáng Yêu PAB029
...
- Thiết kế vững chắc, không góc cạnh, hạn chế làm trầy xước da bé.
- Sản phẩm được làm từ nhựa ABS cao cấp, tránh biến dạng khi va đập, kéo dài thời gian sử dụng.
- Xe được mô phỏng y như thật cùng màu vàng chủ đạo đẹp mắt giúp bé hiểu biết thêm về hoạt động của xe ngoài thực tế. Tăng vốn hiểu biết của trẻ.
- Sản phẩm phù hợp với các bé trai trên 3 tuổi.
Đồ chơi Mô hình xe theo tỷ lệ thu nhỏ 1:16 xe tải cần cẩu – BRUDER BRU03570gồm:
01 Xe tải cần cẩu BRU03570.
Giá trị sản phẩm mang lại:


-Xe mô hìnhgiúp bé phát triển các kỹ năng vận động của trẻ thông qua việc khám phá và sử dụng các chức năng của xe
...
✅  Sản  phẩm  được  Mykingdom  phân  phối  chính  hãng  từ  thương  hiệu  HOT  WHEELS
***  Lưu  ý:  Sản  phẩm  được  trả  phải  trong  tình  trạng  nguyên  vẹn  như  khi  nhận  hàng,  chưa  bóc  hộp,  chưa  qua  sử  dụng

1️⃣  Thông  tin  sản  phẩm:
Mô  Hình  Đồ  Chơi  Hot  Wheels  Đường  Đua  Xoắn  Kép  Siêu  Tốc  Xếp  Gọn  (Mã  sản  phẩm:  GFH85)
Đồ  chơi  đường  đua  xoắn  kép  siêu  tốc  xếp  gọn  Hot  Wheels  GFH85  là  nơi  trẻ  em  có  thể  tổ  chức  các  cuộc  đua  chạy  với  một  người  bạn  nữa.  Sản  phẩm  được  thiết  kế  để  các  tay  lái  xe  Hot  Wheels  thi  đấu  với  nhau  hoặc  bé  có  thể  kiểm  tra,  so  sánh  hiệu  suất  của  từng  dòng  xe.
Bộ  playset  &  phụ  kiện  đường  đua  xoắn  kép  siêu  tốc  xếp  gọn  Hot  Wheels  GFH85  có  các  đặc  điểm  nổi  bật  sau:
Đồ  chơi  đường  đua  xoắn  kép  siêu  tốc  xếp  gọn  Hot  Wheels  GFH85  bao  gồm:01  đường  đua  xoắn  kép  siêu  tốc  xếp  gọn và 02  siêu  xe  Hot  Wheels  tỉ  lệ  1/64.
-  Kích  thước  hộp  hàng  sản  phẩm:  46x6.5x38.5  cm
-  Chất  liệu  sản  phẩm:  Nhựa  ABS  Cao  Cấp,  Kim  loại
-  Đóng  gói  sản  phẩm:  Hộp  tiêu  chuẩn,  bao  bì  hộp  màu

2️⃣  Nguồn  gốc  xuất  xứ  sản  phẩm
-  Thương  hiệu  sản  xuất:  HOT  WHEELS
-  Phân  phối  chính  hãng:  Mykingdom
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (25, 594300, NULL, 63, 'Trạm Cá Sấu Pizza Hot Wheels City HOT WHEELS HDR29', JSON_OBJECT('Chủ đề', 'HOT WHEELS CITY', 'Mã sản phẩm', 'HKX39/HDR29', 'Tuổi', '4 tuổi trở lên', 'Thương hiệu', 'HOT WHEELS', 'Xuất xứ thương hiệu', 'Mỹ', 'Giới tính', 'Unisex', 'Nơi sản xuất', 'VIETNAM'), 'Mô  Hình  Đồ  Chơi  Hot  Wheels  Trạm  Cá  Sấu  Pizza  City  HKX39/HDR29
✅  Nhận  hàng  nhanh  chóng  từ  1  -  3  ngày  (không  tính  T7  -  CN)
✅  Sản  phẩm  mới  100%  Full  Box,  3  ngày  miễn  phí  trả  hàng
✅  Sản  phẩm  được  Mykingdom  phân  phối  chính  hãng  từ  thương  hiệu  HOT  WHEELS
***  Lưu  ý:  Sản  phẩm  được  trả  phải  trong  tình  trạng  nguyên  vẹn  như  khi  nhận  hàng,  chưa  bóc  hộp,  chưa  qua  sử  dụng
...
1️⃣  Thông  tin  sản  phẩm:
Mô  Hình  Đồ  Chơi  Hot  Wheels  Trạm  Cá  Sấu  Pizza  City  (Mã  sản  phẩm:  HKX39/HDR29)
Hạ  gục  một  con  cá  sấu  hung  ác  đang  xâm  chiếm  tiệm  bánh  pizza  bằng  những  pha  cực  nguy  hiểm  và  lối  chơi  thú  vị  trong  bộ  trò  chơi  này.
Phóng  chiếc  xe  Hot  Wheels  của  mình  vào  miệng  cá  sấu,  sau  đó  thông  qua  chiếc  đuôi  có  thể  điều  chỉnh  của  nó.
Cố  gắng  đi  qua  một  cách  an  toàn  và  đi  ngang  qua  biển  hiệu  bánh  pizza,  biển  hiệu  sẽ  quay  khi  xe  thoát  ra
Với  nhiều  điểm  kết  nối  trên  đế,  có  thể  tham  gia  bộ  này  với  những  người  khác  và  xây  dựng  thế  giới  phiêu  lưu  của  Hot  Wheels  (Các  bộ  bổ  sung  được  bán  riêng)
Bao  gồm  1  xe  Hot  Wheels  tỷ  lệ  1:64.
-  Kích  thước  sản  phẩm:  30.5x9x25.5  cm
-  Chất  liệu  sản  phẩm:  Nhựa  ABS  Cao  Cấp,  Kim  loại
-  Đóng  gói  sản  phẩm:  Hộp  tiêu  chuẩn,  bao  bì  hộp  màu
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (26, 2159400, NULL, 65, 'Đồ chơi mô hình tỷ lệ 1:16 xe tải cần cẩu SCANIA BRUDER BRU03570', JSON_OBJECT('Chủ đề', 'BRUDER CONSTRUCTION', 'Mã sản phẩm', 'BRU03570', 'Tuổi', '4 tuổi trở lên', 'Thương hiệu', 'BRUDER', 'Xuất xứ thương hiệu', 'ĐỨC', 'Giới tính', 'Preschool', 'Nơi sản xuất', 'ĐỨC'), 'Mô Hình Xe Theo Tỷ Lệ Thu Nhỏ 1:16 Xe Tải Cần Cẩu- BRUDER BRU03570
Mô hình xe theo tỷ lệ thu nhỏ 1:16 xe tải cần cẩu – BRUDER BRU03570là một trong những sản phẩm hàng đầu của thương hiệu đồ chơi Bruder. Xe tải cần cẩu lấy cảm hứng từ thực tế cuộc sống, giúp bé hiểu biết hơn về nghề kỹ sư xây dựng. Sản phẩm được thiết kế với hệ thống đèn và chuông báo hiệu giống với xe ngoài đời thật, kích thích sự tò mò, khả năng khám phá của trẻ. Các đường nét của món đồ chơi được thiết kế tỉ mỉ, tinh tế, mang đến trải nghiệm chân thật nhất cho bé yêu của bạn.
Đồ chơi dạng mô hình theo tỷ lệ thu nhỏ 1:16 xe tải cần cẩutrở thành sự lựa chọn của nhiều bậc phụ huynh trên thế giới bởi những đặc điểm nổi bật sau:
- Cần trục xe cao đến 1,3m khi cánh tay cẩu vươn ra hết cỡ
- Thiết kế vững chắc, không góc cạnh, hạn chế làm trầy xước da bé.
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (27, 539000, NULL, 82, 'Trạm Giữ Xe Hot Wheels City HOT WHEELS HDR24', JSON_OBJECT('Chủ đề', 'HOT WHEELS CITY', 'Mã sản phẩm', 'HDR28/HDR24', 'Tuổi', '4 tuổi trở lên', 'Thương hiệu', 'HOT WHEELS', 'Xuất xứ thương hiệu', 'Mỹ', 'Giới tính', 'Unisex', 'Nơi sản xuất', 'VIETNAM'), 'Mô Hình Đồ Chơi Hot Wheels Trạm Giữ Xe HDR28/HDR24
✅ Nhận hàng nhanh chóng từ 1 - 3 ngày (không tính T7 - CN)
✅ Sản phẩm mới 100% Full Box, 3 ngày miễn phí trả hàng
✅ Sản phẩm được Mykingdom phân phối chính hãng từ thương hiệu HOT WHEELS
*** Lưu ý: Sản phẩm được trả phải trong tình trạng nguyên vẹn như khi nhận hàng, chưa bóc hộp, chưa qua sử dụng
...
1️⃣ Thông tin sản phẩm:
Mô Hình Đồ Chơi Hot Wheels Trạm Giữ Xe (Mã sản phẩm: HDR28/HDR24)
Hot Wheels là dòng đồ chơi xe mô hình cực kì được yêu thích tại Mỹ và nhiều nước trên thế giới, trực thuộc tập đoàn đồ chơi Mattel nổi tiếng hàng đầu hiện nay. Với kỹ thuật hiện đại và thiết kế tinh xảo, những chiếc xe Hot Wheels không chỉ là đồ chơi, mà nó còn mang đến trải nghiệm hoàn hảo cho người mê xe mô hình. Mô hình xe Hot Wheels giúp trẻ phát triển tư duy, kích thích trí sáng tạo và rèn luyện sự linh hoạt cho đôi tay của các bé.
- Kích thước hộp hàng sản phẩm: 25.5x21.7x7.7 cm
- Chất liệu sản phẩm:  Nhựa ABS Cao Cấp, Kim loại
- Đóng gói sản phẩm: Hộp tiêu chuẩn, bao bì hộp màu
...
Kích thước:22.6 x 7.5 x 5.4 cm

Chủ đề:SIKU SUPER 1:87
...
ĐỒ CHƠI GIÁO DỤC – Thiết kế mô phỏng dựa trên các mẫu xe thực tế, không chỉ có xe hơi mà còn bao gồm cả các loại xe khác trong thành phố giúp bé vừa chơi vừa học thêm về thế giới quan xung quanh.

BẢN QUYỀN- Các dòng xe đều có bản quyền từ các thương hiệu xe nổi tiếng trên thế giới.

CHI TIẾT TINH XẢO – từ dàn đèn, vỏ xe đến màu sơn đều được chăm chút tỉ mỉ, một số dòng xe có thể mở các cánh cửa
...
Con Quay B-193 Booster Ultimate Valkyrie.Lg.V’-9 là sản phẩm đồ chơi dựa theo bộ phim hoạt hình Beyblade phát sóng trên YouTube Takaratomy.
...
- Chất liệu nhựa và kim loại tạo độ cứng cáp cho sản phẩm.
- Thương hiệu Takara Tomy Nhật Bản, sản xuất tại Việt Nam.
Con Quay B-180 Booster Dynamite Belial.Nx.Vn-2 là sản phẩm đồ chơi dựa theo bộ phim hoạt hình Beyblade phát sóng trên YouTube Takaratomy.
Sản phẩm đồ chơi được sản xuất theo công nghệ Nhật Bản: Tự tay lắp ráp và dán nhãn các chi tiết Có khả năng tùy biến cao, cho phép người dùng tự do sáng tạo, lắp ráp các bộ phận từ nhiều con quay khác nhau.
Bên trong sản phẩm có sách hướng dẫn đi kèm giúp việc lắp ráp dễ dàng.
Lưu ý:
- Sản phẩm KHÔNG có tay cầm
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (40, 279300, NULL, 73, 'Robot Biến Hình Cỡ Lớn Jett Tia Chớp SUPERWINGS YW780210', JSON_OBJECT('Chủ đề', 'SUPERWINGS CHANGE EM UP', 'Mã sản phẩm', 'YW780210', 'Tuổi', '3 tuổi trở lên', 'Thương hiệu', 'SUPERWINGS', 'Xuất xứ thương hiệu', 'Trung Quốc', 'Giới tính', 'Preschool', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi Robot Biến Hình Cỡ Lớn Jett Tia Chớp SUPERWINGS YW780210
Đồ chơi Robot Biến Hình Cỡ Lớn Jett Tia Chớp là sản phẩm thuộc thương hiệu SUPERWINGS. Một sản phẩm đến từ Series phim hoạt hình nổi tiếng được yêu thích trên toàn thế giới - SUPERWINGS ĐỘI BAY SIÊU ĐẲNG.  Trong mùa mới, Jett Tia Chớp được nâng cấp với diện mạo mới - Sức Mạnh Điện.
Đồ chơi mô phỏng nhân vật Jett Tia Chớp:
- Có khả năng biến đổi 2 trạng thái máy bay và robot
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (41, 186750, NULL, 80, 'Bệ Phóng BX-18 String Launcher BEYBLADE X 913054', JSON_OBJECT('Chủ đề', 'BEYBLADE X ACCESSORIES', 'Mã sản phẩm', '913054', 'Tuổi', '6 tuổi trở lên', 'Thương hiệu', 'BEYBLADE X', 'Xuất xứ thương hiệu', 'Nhật Bản', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Việt Nam'), 'Đồ Chơi Bệ Phóng BX-18 String Launcher   BEYBLADE X 913054
- Sản phẩm chỉ là bệ phóng, không có con quay đi kèm
- Phù hợp cho trẻ từ 6 tuổi.
- Chất liệu nhựa và kim loại tạo độ cứng cáp cho sản phẩm.
- Thương hiệu Takara Tomy Nhật Bản, sản xuất tại Việt Nam.
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (42, 118300, NULL, 83, 'Bệ phóng B-137 Long Bey launcher Clear Blue BEYBLADE 4 123842', JSON_OBJECT('Chủ đề', 'BEYBLADE ACCESSORIES', 'Mã sản phẩm', '123842', 'Tuổi', '6 tuổi trở lên', 'Thương hiệu', 'BEYBLADE 4', 'Xuất xứ thương hiệu', 'NHẬT BẢN', 'Giới tính', 'Boy', 'Nơi sản xuất', 'VIỆT NAM'), 'Đồ Chơi BEYBLADE 4 Bệ Phóng B-137 Long Bey Launcher Clear Blue 123842

Bệ phóng B-137 Long Bey launcher Clear Blue 123842là sản phẩm của nhãn hàng Beyblade thuộc thương hiệu Takaratomy nổi tiếng tại Nhật Bản. Đồ chơi mô hình này lấy cảm hứng từ bộ phim hoạt hình Beyblade - Vòng quay thần tốc 4.

Đến với bộ đồ chơi sưu tập này, bé sẽ có cơ hội sở hữu một trong vô số con quay mạnh mẽ của Beyblade trong siêu phẩm phim hoạt hình bộ phim hoạt hình Beyblade - Vòng quay thần tốc 4.

Được sản xuất theo công nghệ đồ chơi Nhật Bản,bệ phóng B-137 Long Bey launcher Clear Blue 123842gây ấn tượng với những đặc điểm nổi bật sau đây:

- Thiết kế mô phỏng theo dụng cụ phóng Beyblade trong phim hoạt hình, từng chi tiết điều tinh xảo và chính xác. Vì vậy, Bệ phóng B-137 Long Bey launcher Clear Blue 123842 như bước ra từ những tập phim hoạt hình chắc chắn sẽ khiến bé thích thú.

- Sản phẩm được làm bằng chất liệu nhựa cao cấp, không chứa chất độc hại. Chuyên sử dụng cho các con quay phải, lực ma sát và lực phóng cực mạnh.

- Mỗi con quay Beyblade đều có sức mạnh và cách biến hình riêng biệt. Sử dụng bộ đồ chơi Bệ phóng B-137 Long Bey launcher Clear Blue 123842 sẽ làm tăng sức mạnh vốn cócủa con quay bé đang sở hữu. Sản phảm khuyến khích các bé học tập tư duy chiến thuật và tinh thần từ các nhân vật trong Beyblade. Hơn nữa, bé sẽ được thỏa thích chơi đùa, trò chuyện hoặc hóa thân trở thành các nhân vật Beyblade. Từ đó kích thích trí tưởng tượng và sáng tạo của trẻ bay cao bay xa.



Bệ phóng B-137 Long Bey launcher Clear Blue 123842bao gồm:

- 01 bệ phóng Beyblade

Vài nét về nhãn hàng Beyblade
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (43, 524250, NULL, 96, 'Con Quay BX-20 Drandagger Deck Set BEYBLADE X 913078', JSON_OBJECT('Chủ đề', 'BEYBLADE X DECK SET', 'Mã sản phẩm', '913078', 'Tuổi', '6 tuổi trở lên', 'Thương hiệu', 'BEYBLADE X', 'Xuất xứ thương hiệu', 'Nhật Bản', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Việt Nam'), 'Đồ Chơi Con Quay BX-20 Drandagger Deck Set BEYBLADE X 913078
- Sản phẩm Đồ Chơi Con Quay BEYBLADE X - Phù hợp cho trẻ từ 6 tuổi.
- Chất liệu nhựa và kim loại tạo độ cứng cáp cho sản phẩm.
- Thương hiệu Takara Tomy Nhật Bản, sản xuất tại Việt Nam.
Con Quay Beyblade X là sản phẩm đồ chơi dựa theo bộ phim hoạt hình Beyblade phát sóng trên YouTube Mykingdom và See TV Sản phẩm đồ chơi được sản xuất theo công nghệ Nhật Bản: Tự tay lắp ráp và dán nhãn các chi tiết Có khả năng tùy biến cao, cho phép người dùng tự do sáng tạo, lắp ráp các bộ phận từ nhiều con quay khác nhau.
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (44, 335300, NULL, 84, 'Robot Siêu Cảnh Sát Bầu Trời Jet Cop Phong Năng Miniforce 505005', JSON_OBJECT('Chủ đề', 'MINIFORCE 6 HEAD COPS', 'Mã sản phẩm', '505005', 'Tuổi', '3 tuổi trở lên', 'Thương hiệu', 'MINIFORCE', 'Xuất xứ thương hiệu', 'HÀN QUỐC', 'Giới tính', 'Boy', 'Nơi sản xuất', 'TRUNG QUỐC'), 'Đồ Chơi Robot Siêu Cảnh Sát Bầu Trời Jet Cop Phong Năng Miniforce505005
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (45, 299000, NULL, 91, 'Con Quay BX-14 Random Booster VOL.1 BEYBLADE X 912965', JSON_OBJECT('Chủ đề', 'BEYBLADE X RANDOM BOOSTER', 'Mã sản phẩm', '912965', 'Tuổi', '6 tuổi trở lên', 'Thương hiệu', 'BEYBLADE X', 'Xuất xứ thương hiệu', 'Nhật Bản', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Việt Nam'), 'Đồ Chơi Con Quay BX-14 Random Booster VOL.1 BEYBLADE X 912965 - Giao hàng ngẫu nhiên
- Sản phẩm đồ chơi con quay BEYBLADE X - Phù hợp cho trẻ từ 6 tuổi.
- Chất liệu nhựa và kim loại tạo độ cứng cáp cho sản phẩm.
- Thương hiệu Takara Tomy Nhật Bản, sản xuất tại Việt Nam.
Con Quay Beyblade X là sản phẩm đồ chơi dựa theo bộ phim hoạt hình Beyblade phát sóng trên YouTube Mykingdom và See TV
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (46, 529000, NULL, 78, 'Con Quay BX-23 Starter Phoenixwing BEYBLADE X 913092', JSON_OBJECT('Chủ đề', 'BEYBLADE X STARTER', 'Mã sản phẩm', '913092', 'Tuổi', '6 tuổi trở lên', 'Thương hiệu', 'BEYBLADE X', 'Xuất xứ thương hiệu', 'NHẬT BẢN', 'Giới tính', 'Boy', 'Nơi sản xuất', 'VIỆT NAM'), 'Đồ Chơi Con Quay BX-23 Starter Phoenixwing BEYBLADE X 913092
- Sản phẩm đồ chơi con quay Beyblade X
- Phù hợp cho trẻ từ 6 tuổi.
- Chất liệu nhựa và kim loại tạo độ cứng cáp cho sản phẩm.
- Thương hiệu Takara Tomy Nhật Bản, sản xuất tại Việt Nam.
- Con Quay Beyblade X là sản phẩm đồ chơi dựa theo bộ phim hoạt hình Beyblade phát sóng trên YouTube Mykingdom và See TV
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (47, 299000, NULL, 92, 'Con Quay BX-31 Random Booster Vol.3 BEYBLADE X 914532', JSON_OBJECT('Chủ đề', 'BEYBLADE X RANDOM BOOSTER', 'Mã sản phẩm', '914532', 'Tuổi', '6 tuổi trở lên', 'Thương hiệu', 'BEYBLADE X', 'Xuất xứ thương hiệu', 'Nhật Bản', 'Giới tính', 'Boy', 'Nơi sản xuất', 'Việt Nam'), 'Đồ Chơi Con Quay BX-31 Random Booster Vol.3 BEYBLADE X 914532 - Giao hàng ngẫu nhiên
- Sản phẩm Đồ Chơi Con Quay BEYBLADE X - Phù hợp cho trẻ từ 6 tuổi.
- Chất liệu nhựa và kim loại tạo độ cứng cáp cho sản phẩm.
- Thương hiệu Takara Tomy Nhật Bản, sản xuất tại Việt Nam.
Con Quay Beyblade X là sản phẩm đồ chơi dựa theo bộ phim hoạt hình Beyblade phát sóng trên YouTube Mykingdom và See TV
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (50, 369000, NULL, 59, 'Xe cứu hộ cơ bản Paw Patrol - Chase PAW PATROL 6069059', JSON_OBJECT('Chủ đề', 'PAWPATROL RESCUE VEHICLE', 'Mã sản phẩm', '6069059', 'Tuổi', '3 tuổi trở lên', 'Thương hiệu', 'PAW PATROL', 'Xuất xứ thương hiệu', 'Canada', 'Giới tính', 'Preschool', 'Nơi sản xuất', 'Việt Nam'), 'Đồ Chơi Xe Cứu Hộ Cơ Bản Chase PAW PATROL 6069059
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (52, 369000, NULL, 44, 'Xe cứu hộ cơ bản Paw Patrol - Marshall PAW PATROL 6069058', JSON_OBJECT('Chủ đề', 'PAWPATROL RESCUE VEHICLE', 'Mã sản phẩm', '6069058', 'Tuổi', '3 tuổi trở lên', 'Thương hiệu', 'PAW PATROL', 'Xuất xứ thương hiệu', 'Canada', 'Giới tính', 'Preschool', 'Nơi sản xuất', 'Việt Nam'), 'Đồ Chơi Xe Cứu Hộ Cơ Bản Marshall PAW PATROL 6069058

Thương hiệu: Spin Master đến từ Canada.Bộ đồ chơi bao gồm:• 1 nhân vật chó cứu hộ Marshall• 1 xe cứu hỏa.
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (53, 369000, NULL, 45, 'Xe cứu hộ cơ bản Paw Patrol - Marshall PAW PATROL 6061798', JSON_OBJECT('Chủ đề', 'PAWPATROL RESCUE VEHICLE', 'Mã sản phẩm', '6061798', 'Tuổi', '1 tuổi trở lên', 'Thương hiệu', 'PAW PATROL', 'Xuất xứ thương hiệu', 'CANADA', 'Giới tính', 'Preschool', 'Nơi sản xuất', 'Việt Nam'), 'Đồ Chơi PAW PATROL Xe Cứu Hộ Cơ Bản - Marshall 6061798
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (55, 369000, NULL, 91, 'Xe cứu hộ cơ bản Paw Patrol - Skye PAW PATROL 6061800', JSON_OBJECT('Chủ đề', 'PAWPATROL RESCUE VEHICLE', 'Mã sản phẩm', '6061800', 'Tuổi', '1 tuổi trở lên', 'Thương hiệu', 'PAW PATROL', 'Xuất xứ thương hiệu', 'CANADA', 'Giới tính', 'Preschool', 'Nơi sản xuất', 'Việt Nam'), 'Đồ Chơi PAW PATROL Xe Cứu Hộ Cơ Bản - Skye 6061800
Thương hiệu: Spin Master đến từ Canada.
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (63, 179000, NULL, 90, 'Đồ Chơi Mô Hình Con Vật Hoạt Hình Trong How To Train Your DRAGON 6072554', JSON_OBJECT('Chủ đề', 'DRAGON COLLECTIBLE', 'Mã sản phẩm', '6072554', 'Tuổi', '4 tuổi trở lên', 'Thương hiệu', 'DRAGON', 'Xuất xứ thương hiệu', 'Canada', 'Giới tính', 'Unisex', 'Nơi sản xuất', 'Việt Nam'), 'Đồ Chơi Mô Hình Con Vật Hoạt Hình Trong How To Train Your DRAGON 6072554 - Giao Hàng Ngẫu Nhiên
Sưu tập ngay những chú rồng xứ Berk phiên bản Mini (giao hàng ngẫu nhiên).
Tự tay lắp ráp nên những chú rồng của riêng bạn. Mỗi sản phẩm sẽ gồm 1 hộp Sách cổ Vikings làm giá đứng, 1 túi chứa các bộ phận Rồng, 1 card sưu tầm
- Night Fury
- Răng Sún (Toothless) với hiệu ứng cánh độc đáo
- Hideous Zippleback
- Deadly Nadder
- Gronkle
- Monstrous Nightmare
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (64, 99500, NULL, 60, 'Mô Hình Khủng Long Slash 6 inch JURASSIC WORLD MATTEL GWT49', JSON_OBJECT('Chủ đề', 'JURASSIC WORLD MT MOVIE', 'Mã sản phẩm', 'GWT51/GWT49', 'Tuổi', '4 tuổi trở lên', 'Thương hiệu', 'JURASSIC WORLD MATTEL', 'Xuất xứ thương hiệu', 'Mỹ', 'Giới tính', 'Unisex', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi JURASIC WORLD MATTEL Khủng Long Slash 6 Inch GWT51/GWT49
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (65, 99500, NULL, 31, 'Mô Hình Khủng Long Slash 6 inch JURASSIC WORLD MATTEL GWT49', JSON_OBJECT('Chủ đề', 'JURASSIC WORLD MT MOVIE', 'Mã sản phẩm', 'GWT51/GWT49', 'Tuổi', '4 tuổi trở lên', 'Thương hiệu', 'JURASSIC WORLD MATTEL', 'Xuất xứ thương hiệu', 'Mỹ', 'Giới tính', 'Unisex', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi JURASIC WORLD MATTEL Khủng Long Slash 6 Inch GWT51/GWT49
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (67, 99500, NULL, 31, 'Mô Hình Khủng Long VELOCIRAPTOR BLUE 6 inch JURASSIC WORLD MATTEL GWT49', JSON_OBJECT('Chủ đề', 'JURASSIC WORLD MT MOVIE', 'Mã sản phẩm', 'HMK81/GWT49', 'Tuổi', '4 tuổi trở lên', 'Thương hiệu', 'JURASSIC WORLD MATTEL', 'Xuất xứ thương hiệu', 'Mỹ', 'Giới tính', 'Unisex', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi JURASSIC WORLD MATTEL Khủng Long Velociraptor Blue 6 Inch HMK81/GWT49
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (68, 269000, NULL, 17, 'Đồ Chơi Sa Bàn Khủng Long Jurassic World - Thủy Quái Vô Đối TOY MONSTER T01535', JSON_OBJECT('Chủ đề', 'TOY MONSTER DINORAMA', 'Mã sản phẩm', 'SEA/T01535', 'Tuổi', '3 tuổi trở lên', 'Thương hiệu', 'TOY MONSTER', 'Xuất xứ thương hiệu', 'Trung Quốc', 'Giới tính', 'Unisex', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi Sa Bàn Khủng Long Jurassic World - Thủy Quái Vô Đối TOY MONSTER SEA/T01535
Sở hữu ngay sa bàn khủng long Jurassic Word - Rebirth để tái hiện những thước phim huyền thoại cùng những giống loài khủng long khác nhau!
Xây dựng thế giới Captivz của bạn với các cảnh Dinorama có thể sưu tầm, cách chơi kết nối và gập gọn hoàn toàn mới. Với ba cảnh quan để sưu tầm: khủng long trên không, trên đất liền và dưới biển, sống động như những cảnh phim JW4 Rebirth yêu thích của bạn.
...
INSERT INTO `products` (`id`, `price`, `promotion_id`, `quantity`, `name`, `rest_info`, `description`, `brand_id`, `category_id`)
VALUES
    (69, 1000300, NULL, 20, 'Đồ Chơi Răng Sún Bay Lượn RC (Điều Khiển Từ Xa) DRAGON 6074369', JSON_OBJECT('Chủ đề', 'DRAGON INTERACTIVE', 'Mã sản phẩm', '6074369', 'Tuổi', '4 tuổi trở lên', 'Thương hiệu', 'DRAGON', 'Xuất xứ thương hiệu', 'Canada', 'Giới tính', 'Unisex', 'Nơi sản xuất', 'Trung Quốc'), 'Đồ Chơi Răng Sún Bay Lượn RC (Điều Khiển Từ Xa) DRAGON 6074369
Trở thành chiến binh luyện rồng Viking cùng Răng Sún RC (điều khiển từ xa)
