                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <button class="btn btn-link text-primary text-decoration-none" onclick="location.href='order-details.jsp'">
                                <i class="bi bi-eye-fill"></i>
                            </button>

                            <button class="btn btn-link text-success text-decoration-none" onclick="location.href='order-details.jsp'">
