        ...
        <div class="table-container">
            <table class="table">
                ...
                <tr>
                    ...
                    <th class="sortable text-white text-nowrap " data-column="name">Tên Khách Hàng<i class="fas fa-sort ms-1 text-white"></i></th>
                    <th class="sortable text-white text-nowrap " data-column="email">Tên Sản Phẩm<i class="fas fa-sort ms-1 text-white"></i>
                    </th>
                ...
                <div class="modal-body">
                    <form id="addProductForm" action="/products/save" method="post" enctype="multipart/form-data">
                        ...
                        <table class="table key-value-table" id="kvTableAdd">
                            ...
                            <tbody>
                            <tr>
                                <td class="text-center"><input class="form-control key-input" placeholder="VD: Kích thước"></td>
                                <td class="text-center"><input class="form-control value-input" placeholder="VD: 30x40cm"></td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-danger btn-sm" onclick="removeRow(this)">X</button>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center"><input class="form-control key-input" placeholder="VD: Chất liệu"></td>
                                <td class="text-center"><input class="form-control value-input" placeholder="VD: Nhựa ABS"></td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-danger btn-sm" onclick="removeRow(this)">X</button>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center"><input class="form-control key-input" placeholder="VD: Trọng lượng"></td>
                                <td class="text-center"><input class="form-control value-input" placeholder="VD: 500g"></td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-danger btn-sm" onclick="removeRow(this)">X</button>
                                </td>
                            </tr>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="description" rows="4" placeholder="Nhập mô tả chi tiết về sản phẩm..."></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="imageUploadAdd" name="images" multiple accept="image/*">
                            <div id="previewAdd" class="image-preview mt-2"></div>
                        </div>

                        <div class="mb-3 form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" id="statusAdd" value="true" checked>
                    ...
                    <form id="updateProductForm" action="/products/update" method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex" style="gap: 10px;">
                                <input class="form-control" name="product_id" id="searchProductId" placeholder="Nhập mã sản phẩm..." style="flex: 1;">
                                <button type="button" class="btn btn-secondary" onclick="searchProduct()">
                                    <i class="bi bi-search"></i> Tìm Kiếm
                                </button>
                            </div>
                            <small class="form-text text-muted">Nhập mã sản phẩm và nhấn "Tìm Kiếm" để tải thông tin</small>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <label class="form-label">Giảm Giá (%)</label>
                                <input type="number" class="form-control" name="discount_percent" id="updateDiscount" min="0" max="100">
                            </div>
                            <div class="col">
                                <label class="form-label">Số Lượng <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" name="quantity" id="updateQuantity" required min="0">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Mô Tả Sản Phẩm</label>
                            <textarea class="form-control" name="description" id="updateDescription" rows="4"></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="imageUploadUpdate" name="images" multiple accept="image/*">
                            <div id="previewUpdate" class="image-preview mt-2"></div>
                        </div>

                        <div class="mb-3 form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_active" id="statusUpdate" value="true" checked>
