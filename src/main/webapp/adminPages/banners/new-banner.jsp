...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/admin/banners/new"
          method="post"
        ...
        <div class="form-group">
            ...
            <div class="help-text">Chọn file ảnh (JPG, PNG, GIF). Kích thước đề xuất: 1920x600px</div>
        ...
        <div class="form-group">
            ...
            <select id="groupTag" name="groupTag" required>
                ...
                <option value="TRANG_CHU" ${param.groupTag eq 'TRANG_CHU' ? 'selected' : ''}>Trang chủ (Home)</option>
                <option value="KHUYEN_MAI" ${param.groupTag eq 'KHUYEN_MAI' ? 'selected' : ''}>Trang giảm giá (Discount)</option>
            </select>
        ...
        <div class="form-group">
            ...
            <input type="number"
                   ...
                   name="sortOrder"
                   min="0"
                   value="${param.sortOrder != null ? param.sortOrder : 0}"
                   required>
        ...
        <div class="form-group">
            ...
            <select id="eventId" name="eventId">
                ...
                <c:forEach var="event" items="${events}">
                    <option value="${event.id}" ${param.eventId eq event.id ? 'selected' : ''}>
                            ${event.name}
                    </option>
                </c:forEach>
            </select>
