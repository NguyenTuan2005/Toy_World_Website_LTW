                        ...
                        <form id="contactForm" novalidate>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <small class="text-danger d-none" id="nameError">Vui lòng nhập họ tên</small>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-danger d-none" id="messageError">Vui lòng nhập nội dung tin nhắn</small>
                            </div>

                            <div class="row mb-3">
                                <div class="col-md-8">
                                    <label for="captcha" class="form-label">Mã xác nhận <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="captcha" placeholder="Nhập mã xác nhận">
                                    <small class="text-danger d-none" id="captchaError">Mã xác nhận không đúng</small>
                                </div>
                                <div class="col-md-4 d-flex align-items-end">
                                    <div class="border rounded p-2 bg-light text-center w-100" style="height: 38px; line-height: 34px; font-family: 'Courier New', monospace; font-size: 20px; font-weight: bold; letter-spacing: 5px; user-select: none;">
                                        <span id="captchaCode">A7X9K</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary btn-lg px-5">
                                    <i class="bi bi-send me-2"></i>Xác nhận
                                </button>
                            </div>
                        </form>
                    </div>
